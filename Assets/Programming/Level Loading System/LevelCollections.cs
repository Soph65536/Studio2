...
public static class LevelCollections
{
    ...
    public static string[] LevelEnding = new string[] { "Level_3_Ending" };

    public static bool CheckSceneInCollection(string sceneName)
    {
        if (Level1.Contains(sceneName) || Level2.Contains(sceneName) || LevelEnding.Contains(sceneName)) return true;
        else return false;
    }
    ...
    public static string[] GetCollectionNameFromScene(string sceneName)
    {
        ...
        else if (LevelEnding.Contains(sceneName)) return LevelEnding;
        else return null;
    }
    ...
    public static int GetLevelIDFromSceneName(string sceneName)
    {
        ...
        else if (LevelEnding.Contains(sceneName)) return 3;
        else return 0;
    }
}
